...
class MysqlMessenger():
    """
    Class :  MysqlMessenger
    Description:  Mysql Messenger deals communication with mysql server.
    """    
    def __init__(self, table=None, user="root", password="kid1412", database="matching_system"):
    ...
    def execute_sql(self, sql, log_file=None):
        ...
        @param self Pointer to class
        @param log_file log file used to store error information
        """
        try:
